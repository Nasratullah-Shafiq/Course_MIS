            ...
            <div class = "col-sm-3 text-right">
                <form class=" "  method="POST">
                    <div class="form-group">
                        <label> Search Result Here</label>
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" name ="searchResult" id ="searchResult" placeholder="Search for...">
...
===============================================================================================================================-->
            <div class="col-md-12" id = "Result_Table">
                 <!-- id = "resultReading" -->
            </div>  
<!--=============================================================================================================================
