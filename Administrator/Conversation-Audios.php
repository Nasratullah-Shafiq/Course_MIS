...
<!-- BEGIN LEFT SIDE BAR -->
    ...
    <div class="right-side-bar">
        <!-- <div class="row" style="background: red;"> -->
            <div calss = "col-md-9">
                <h1 style = "color: #2C3E50"> <small> Home <i class = "fa fa-chevron-right" style = "font-size: 15px; padding-left: 5px; padding-right: 5px;"> </i> Conversation Audios </small></h1><hr>
                 <ol class="breadcrumb">
                    <li style="color: #5C9BD1"><a href="index"> <i class = "fa fa-dashboard"></i>  Dashboard </a></li>
                    <li class = ""> <a href="javascript:;" data-toggle="modal" data-target="#Conversation_Audio_Data_Modal">  <img alt="" class="img-circle" width="17px" height = "17px" src = "../Assets/img/icons/Audio_26px.png" />  Add Audio </a></li>
                </ol>
            </div>
            <div class = "col-sm-9">
...
======================================================================================================================-->
<div id="Conversation_Audio_Data_Modal" class="modal Myfade" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
          <h4 class="modal-title" id="myModalLabel"> Add Conversation Audios Here </h4>
        </div>

        <div class="modal-body">
            <form class="form-horizontal" method="POST" id = "Conversation_Audio_Form"  enctype="multipart/form-data">
                      
             <div class="form-group">
                        
                    <label style="text-align: left;" class="col-sm-3 control-label"> Audio </label>
                    <div class="col-sm-9">
                        <input type = "file" name = "Conversation_Audio" id = "Conversation_Audio"/>
                    </div>
                </div> 
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          <label for="Unit" style="text-align: left;" class="col-sm-3 control-label"> Unit </label>
                            <div class="col-sm-9">
                              <select name="Conversation_Unit" id = "Conversation_Unit" class="form-control">
                ...
                <form class=" "  method="POST">
                        <div class="form-group">
                            ...
                            <div class="input-group input-group-sm">
                                <input type="text" class="form-control" name ="search_Conversation_Audio" id ="search_Conversation_Audio" placeholder="Search for...">
...
===============================================================================================================================-->
            <div class="col-md-12" id = "Conversation_Audio_Table">
...
<div id = "Edit-Conversation-Audio-Modal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title"> Edit Conversation Audio Here...</h4>
            </div>
            <div class="modal-body">
                <form class="form-horizontal" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group" style="display: none;">
                        ...
                        <div class="col-sm-9">
                          <input type="text" class="form-control" name = "Edit_Conversation_Audio_ID" id="Edit_Conversation_Audio_ID" placeholder="ID">
                        </div>
                    </div> 
                      <div class="form-group">
                          <label for="Book" style="text-align: left;" class="col-sm-3 control-label"> Book </label>
                            <div class="col-sm-9">
                                <select name="Edit_Conversation_Book" id = "Edit_Conversation_Book" class="form-control">
                                    <option value="Start-Up"> Start-Up </option>
                                    <option value="Open-Up"> Open-Up </option>
                                    <option value="Warm-Up"> Warm-Up </option>
                                    <option value="Run-Up"> Run-Up </option>
                      ...
                      <div class="form-group">
                          <label for="Unit" style="text-align: left;" class="col-sm-3 control-label"> Unit </label>
                            <div class="col-sm-9">
                                <select name="Edit_Conversation_Unit" id = "Edit_Conversation_Unit" class="form-control">
                                   <option value="Unit 1"> Unit One  </option>
                                   <option value="Unit 2"> Unit Tow  </option>
                                   <option value="Unit 3"> Unit Three  </option>
                                   <option value="Unit 4"> Unit Four  </option>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-9">
                        <button type="submit" class="button-start-the-quiz" name="btn-edit-conversation-audio" id = "btn-edit-conversation-audio" > Update </button>
