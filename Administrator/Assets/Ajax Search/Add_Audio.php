<?php
	...
	$crd = new CRUD();
 	...
 	if($_SERVER['REQUEST_METHOD'] == 'POST'){
        ...
        $Audio = $crd->upload_audio($_FILES["Change_Audio"]);
    	...
    	$adioAdd = $crd->addAudio($Audio, $Question, $First_Answer, $Second_Answer, $Third_Answer, $Fourth_Answer, $Right_Answer, $Book_ID, $Description);
